...
public partial class AdvancedSearchWindow : Window
{
    ...
    private static readonly WorkflowCommand[] WorkflowCommands =
    {
        ...
        new("Installer and updates", "Open Settings & Backup for installer choice, update-channel boundaries and manual distribution checks.", "Settings & Backup", Keywords: "installer update packaging shortcut msix inno setup portable publish distribution"),
        new("Installer validation checklist", "Open Settings & Backup for portable publish validation, update rehearsal gates and installer hold conditions.", "Settings & Backup", Keywords: "installer validation checklist portable publish fingerprint sha256 update rehearsal rollback msix inno setup"),
        new("Portable build manifest", "Open Settings & Backup for publish-folder inventory, executable hash and handoff exclusions.", "Settings & Backup", Keywords: "portable build manifest publish folder inventory file hash sha256 handoff distribution package"),
        new("Packaging decision record", "Open Settings & Backup for the portable handoff decision and installer packaging boundaries.", "Settings & Backup", Keywords: "packaging decision record portable handoff msix inno setup installer boundary closure"),
        new("Roadmap completion record", "Open Settings & Backup for completed tracks and remaining explicit major decisions.", "Settings & Backup", Keywords: "roadmap completion record finished future versions remaining decisions complete"),
