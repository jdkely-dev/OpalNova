...
<p class="meta">Generated locally by OPALNOVA. Manual version V1.64.0.</p>
...
<div class="box" id="quotes"><h2>2. Quotes and proposals</h2><ol><li>Use <b>Custom Quote Builder</b> for multi-option custom work. Keep customer details, expiry dates and internal notes current.</li><li>Add quote options with material, labour, stone, setting, finding and other costs. Mark the best option as recommended when appropriate.</li><li>Attach design images to quote options when they help the customer compare designs.</li><li>Preview the proposal, then use the proposal send workflow to copy/open an email draft and record when it was sent.</li><li>Use <b>Proposal Pipeline</b> to review prepared proposals, sent proposals, due follow-ups, accepted quotes and converted jobs from one workspace queue.</li><li>After customer approval, mark the accepted option and convert it into a production job.</li></ol><div class="box warn"><h3>Quote caution</h3><p>Do not mark an option accepted until the customer has clearly approved it. Accepted quotes can drive job creation, reserved stock and follow-up actions.</p></div></div>
