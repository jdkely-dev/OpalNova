...
<p class="meta">Generated locally by OPALNOVA. Manual version V1.75.0.</p>
...
<div class="box" id="setup"><h2>1. Setup and daily rhythm</h2><ol><li>Open <b>Settings</b> and confirm business name, contact details, logo, document footer, tax/GST settings, printout folder and backup folder.</li><li>Add suppliers, customers, materials, stones and jewellery stock before relying on reports.</li><li>Use the dashboard setup-readiness card and Alert Centre to find missing setup, overdue work, low stock and follow-ups.</li><li>Use Customer Relationship Studio for customer summary cards, timelines, communication templates, value guidance and follow-up creation.</li><li>When closing changed record editor tabs, choose Save, Discard or Cancel from the unsaved-change prompt.</li><li>Run <b>Create Backup</b> before importing CSV files, restoring data, bulk cleanup, or major stock status changes.</li></ol><p class="small">Daily habit: open Alert Centre, review Project Workbench, process payments and follow-ups, then back up after important changes.</p></div>
